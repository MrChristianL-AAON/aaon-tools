<script lang="ts">
    ...
    import BoxDark from '$lib/assets/box-dark.svg';
    import { goto } from '$app/navigation';

    export let path = '/commands'; // Add prop for navigation path
    export let title = 'Command Packaging'; // Add prop for title
    export let description = 'Click here build secure MQTT command packages.'; // Add prop for description
